                ...
                <div class="alazea-service-area mb-100">
                    ...
                    <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="service-icon mr-30">
                            <img src="{{ asset('frontend/assets/img/core-img/s1.png') }}" alt="">
                        </div>
                        <!-- Content -->
                    ...
                    <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="300ms">
                        <!-- Icon -->
                        <div class="service-icon mr-30">
                            <img src="{{ asset('frontend/assets/img/core-img/s2.png') }}" alt="">
                        </div>
                        <!-- Content -->
                        <div class="service-content">
                    ...
                    <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="500ms">
                        <!-- Icon -->
                        <div class="service-icon mr-30">
                            <img src="{{ asset('frontend/assets/img/core-img/s3.png') }}" alt="">
                        </div>
                        <!-- Content -->
                        <div class="service-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="single-benefits-area">
                                <img src="{{ asset('frontend/assets/img/core-img/b1.png') }}" alt="">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="single-benefits-area">
                                <img src="{{ asset('frontend/assets/img/core-img/b2.png') }}" alt="">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="single-benefits-area">
                                <img src="{{ asset('frontend/assets/img/core-img/b3.png') }}" alt="">
                                <h5>100% Natural</h5>
                                <p>Intiam eu sagittis est, at commodo lacini libero. Praesent dignissim sed odio vel aliquam manta lagorn.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="single-benefits-area">
                                <img src="{{ asset('frontend/assets/img/core-img/b4.png') }}" alt="">
        ...
        <div class="row alazea-portfolio">
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item design home-design wow fadeInUp" data-wow-delay="100ms">
                ...
                <div class="portfolio-hover-overlay">
                    <a href="{{ asset('frontend/assets/img/bg-img/16.jpg') }}" class="portfolio-img d-flex align-items-center justify-content-center" title="Portfolio 1">
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
                ...
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{ asset('frontend/assets/img/bg-img/17.jpg') }}" class="portfolio-img d-flex align-items-center justify-content-center" title="Portfolio 2">
                        <div class="port-hover-text">
                            <h3>Minimal Flower Store</h3>
                            <h5>Office Plants</h5>
                        </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden design wow fadeInUp" data-wow-delay="300ms">
                ...
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{ asset('frontend/assets/img/bg-img/18.jpg') }}" class="portfolio-img d-flex align-items-center justify-content-center" title="Portfolio 3">
                        <div class="port-hover-text">
                            <h3>Minimal Flower Store</h3>
                            <h5>Office Plants</h5>
                        </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden office-design wow fadeInUp" data-wow-delay="400ms">
                ...
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{ asset('frontend/assets/img/bg-img/19.jpg') }}" class="portfolio-img d-flex align-items-center justify-content-center" title="Portfolio 4">
                        <div class="port-hover-text">
                            <h3>Minimal Flower Store</h3>
                            <h5>Office Plants</h5>
                        </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item design office-design wow fadeInUp" data-wow-delay="100ms">
                ...
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{ asset('frontend/assets/img/bg-img/20.jpg') }}" class="portfolio-img d-flex align-items-center justify-content-center" title="Portfolio 5">
                        <div class="port-hover-text">
                            <h3>Minimal Flower Store</h3>
                            <h5>Office Plants</h5>
                        </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
                ...
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{ asset('frontend/assets/img/bg-img/21.jpg') }}" class="portfolio-img d-flex align-items-center justify-content-center" title="Portfolio 6">
                        <div class="port-hover-text">
                            <h3>Minimal Flower Store</h3>
                            <h5>Office Plants</h5>
                        </div>
            ...
            <div class="col-12 col-lg-6 single_portfolio_item home-design wow fadeInUp" data-wow-delay="300ms">
                ...
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{ asset('frontend/assets/img/bg-img/22.jpg') }}" class="portfolio-img d-flex align-items-center justify-content-center" title="Portfolio 7">
                        <div class="port-hover-text">
                            <h3>Minimal Flower Store</h3>
                            <h5>Office Plants</h5>
                        </div>
                ...
                <div class="testimonials-slides owl-carousel">
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="testimonial-thumb">
                                    <img src="{{ asset('frontend/assets/img/bg-img/13.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                    ...
                    <div class="single-testimonial-slide">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="testimonial-thumb">
                                    <img src="{{ asset('frontend/assets/img/bg-img/14.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="testimonial-content">
                    ...
                    <div class="single-testimonial-slide">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="testimonial-thumb">
                                    <img src="{{ asset('frontend/assets/img/bg-img/15.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="testimonial-content">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="100ms">
                    ...
                    <div class="product-img">
                        <a href="shop-details.html"><img src="{{ asset('frontend/assets/img/bg-img/9.jpg') }}" alt=""></a>
                        <!-- Product Tag -->
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="200ms">
                    <!-- Product Image -->
                    <div class="product-img">
                        <a href="shop-details.html"><img src="{{ asset('frontend/assets/img/bg-img/10.jpg') }}" alt=""></a>
                        <div class="product-meta d-flex">
                            <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                            <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="300ms">
                    <!-- Product Image -->
                    <div class="product-img">
                        <a href="shop-details.html"><img src="{{ asset('frontend/assets/img/bg-img/11.jpg') }}" alt=""></a>
                        <div class="product-meta d-flex">
                            <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                            <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                            <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="400ms">
                    <!-- Product Image -->
                    <div class="product-img">
                        <a href="shop-details.html"><img src="{{ asset('frontend/assets/img/bg-img/12.jpg') }}" alt=""></a>
                        <!-- Product Tag -->
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-post mb-100">
                    <div class="post-thumbnail mb-30">
                        <a href="single-post.html"><img src="{{ asset('frontend/assets/img/bg-img/6.jpg') }}" alt=""></a>
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-post mb-100">
                    <div class="post-thumbnail mb-30">
                        <a href="single-post.html"><img src="{{ asset('frontend/assets/img/bg-img/7.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-content">
                        <a href="single-post.html" class="post-title">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-post mb-100">
                    <div class="post-thumbnail mb-30">
                        <a href="single-post.html"><img src="{{ asset('frontend/assets/img/bg-img/8.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-content">
                        <a href="single-post.html" class="post-title">
...
<section class="subscribe-newsletter-area" style="background-image: url({{ asset('frontend/assets/img/bg-img/subscribe.png') }});">
    <div class="container">
    ...
    <div class="subscribe-side-thumb wow fadeInUp" data-wow-delay="500ms">
        <img class="first-img" src="{{ asset('frontend/assets/img/core-img/leaf.png') }}" alt="">
    </div>
</section>
<!-- ##### Subscribe Area End ##### -->
